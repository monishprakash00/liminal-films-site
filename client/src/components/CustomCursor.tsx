...
export function CustomCursor() {
  ...
  return (
    <motion.div
      className={`fixed top-0 left-0 w-8 h-8 pointer-events-none z-[100] mix-blend-difference text-primary transition-opacity duration-1000 ease-in-out opacity-100`}
      style={{
        x: cursorXSpring,
        y: cursorYSpring,
      }}
